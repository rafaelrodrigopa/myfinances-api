...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public BigDecimal obterSaldoPorUsuario(Long id) {
		BigDecimal receitas = repository.obterSaldoPorTipoLancEUsuario(id, TipoLancamento.RECEITA, StatusLancamento.EFETIVADO);
		BigDecimal despesas = repository.obterSaldoPorTipoLancEUsuario(id, TipoLancamento.DESPESA, StatusLancamento.EFETIVADO);
